...
document
  ...
  .addEventListener("submit", function (event) {
    ...
    var checkedAllergies = document.querySelectorAll(
      "input[type='checkbox'][name='allergies']:checked"
    );
    ...
    displayYouTubeResults(searchInput, diet, allergies, apiKeyYT);
  });
...
function displayYouTubeResults(searchPar, dietPar, allergiesPar, apiKeyPar) {
